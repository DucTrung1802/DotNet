...
namespace MagicVilla.Migrations
{
    ...
    [Migration("20240321052724_SeedVillaTable")]
            ...
            modelBuilder.Entity("MagicVilla.Models.Villa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 3, 21, 12, 27, 24, 238, DateTimeKind.Local).AddTicks(9200),
                            ...
                            Rate = 500.0,
                            Sqft = 3500,
                            UpdatedDate = new DateTime(2024, 3, 21, 12, 27, 24, 238, DateTimeKind.Local).AddTicks(9211)
                        },
                        new
                        {
                            Id = 2,
                            Amenity = "Direct beach access, Outdoor dining area",
                            CreatedDate = new DateTime(2024, 3, 21, 12, 27, 24, 238, DateTimeKind.Local).AddTicks(9213),
                            ...
                            Rate = 400.0,
                            Sqft = 2800,
                            UpdatedDate = new DateTime(2024, 3, 21, 12, 27, 24, 238, DateTimeKind.Local).AddTicks(9214)
                        },
                        new
                        {
                            Id = 3,
                            Amenity = "Fireplace, Hiking trails nearby",
                            CreatedDate = new DateTime(2024, 3, 21, 12, 27, 24, 238, DateTimeKind.Local).AddTicks(9216),
                            ...
                            Rate = 300.0,
                            Sqft = 2000,
                            UpdatedDate = new DateTime(2024, 3, 21, 12, 27, 24, 238, DateTimeKind.Local).AddTicks(9216)
                        },
                        new
                        {
                            Id = 4,
                            Amenity = "Garden, Outdoor seating area",
                            CreatedDate = new DateTime(2024, 3, 21, 12, 27, 24, 238, DateTimeKind.Local).AddTicks(9218),
                            ...
                            Rate = 250.0,
                            Sqft = 1800,
                            UpdatedDate = new DateTime(2024, 3, 21, 12, 27, 24, 238, DateTimeKind.Local).AddTicks(9218)
                        },
                        new
                        {
                            Id = 5,
                            Amenity = "Rooftop terrace, Gym facilities",
                            CreatedDate = new DateTime(2024, 3, 21, 12, 27, 24, 238, DateTimeKind.Local).AddTicks(9220),
                            ...
                            Rate = 600.0,
                            Sqft = 3200,
                            UpdatedDate = new DateTime(2024, 3, 21, 12, 27, 24, 238, DateTimeKind.Local).AddTicks(9220)
                        });
                });
